...
### Document Collection
- Automated collection of model cards, usage policies, and safety frameworks from **OpenAI, Anthropic, Google DeepMind, Meta, Mistral,** and **xAI**
...
| Lab | Count | Documents |
|---|---|---|
| **Anthropic** | 21 | Claude 2/3/3.5/3.7/4 system cards, Opus 4.1/4.5/4.6/4.7/4.8, Sonnet 4.5/4.6, Haiku 4.5, Mythos Preview, RSP, constitutional AI, character, safeguards |
| **OpenAI** | 16 | GPT-4/4o/4.5/5/5.1/5.2 system cards, GPT-5.3 Codex, o1/o3/o3-mini, Operator, model spec, preparedness framework |
...
Earlier snapshots also tracked Cohere, Amazon, and AI21 (governance docs only); they are no longer in the corpus. Counts are generated by `scripts/compute_stats.py` (total **79** documents).
