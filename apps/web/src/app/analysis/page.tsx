    ...
    <div>
      ...
      <div className="mb-8 p-4 rounded-xl border border-[var(--border)] bg-surface-1">
        ...
        <ul className="text-xs text-[var(--muted)] space-y-1.5 leading-relaxed">
          <li><span className="inline-block w-3 h-3 rounded bg-accent align-middle mr-1.5"></span><strong className="text-white">Strong (0.70+)</strong> = The lab has detailed, dedicated policy on this topic</li>
          <li><span className="inline-block w-3 h-3 rounded bg-accent/60 align-middle mr-1.5"></span><strong className="text-white">Moderate (0.50+)</strong> = The lab addresses this topic meaningfully</li>
          <li><span className="inline-block w-3 h-3 rounded bg-accent/30 align-middle mr-1.5"></span><strong className="text-white">Weak (0.35+)</strong> = Brief mention, but not a focused policy</li>
          <li><span className="inline-block w-3 h-3 rounded bg-surface-2 align-middle mr-1.5"></span><strong className="text-white">Missing</strong> = No meaningful coverage found in their public documents</li>
        </ul>
      </div>
