...
const GEN_ORDER: Record<string, number> = {
  ...
  anthropic_haiku45_card: 7, anthropic_opus41_card: 8,
  anthropic_sonnet46_card: 9,
  ...
  google_gemini_25_card: 4, google_gemini_25_pro_card: 5,
  google_gemini_3_card: 6, google_gemini_3_pro_card: 7,
